...
init -1 python hide:
    ...
    config.window_title = u"Jim del Espacio Exterior 2"
    ...
    style.default.font = "DejaVuSans-Oblique.ttf"
...
python early:
    config.save_directory = "Jim2-1447422965"
...
init python:
    ...
    build.directory_name = "Jim2-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Jim2"
